...
const FoodDetails = (props) => {
    ...
    useEffect(() => {
        fetch('https://thawing-temple-99876.herokuapp.com/food/' + id)
            .then((res) => res.json())
            .then((data) => {
                setCurrentFood(data);
            })
        ...
        window.scrollTo(0, 0);
    }, [currentFood.images, currentFood.name, id]);
                ...
                <div className='col-md-6 pr-md-4'>
                    ...
                    <div className='d-flex  my-4'>
                        ...
                        <div className='cart-controller ml-3 btn'>
                            <button className='btn' onClick={() => setQuantity(quantity <= 1 ? 1 : quantity - 1)}>
                                -
                            </button>{' '}
                            {quantity}{' '}
                    ...
                    <div className='action d-flex align-items-center'>
                        <button className='btn btn-danger btn-rounded mb-2' onClick={() => finalCartHandler(currentFood)}>
