            ...
            <div className='card'>
                ...
                <div className='card-body'>
                    <div className='d-flex'>
                        ...
                        <div>
                            <h5> {title} </h5>
                            <p>{descriptionCollapse ? description : description.substr(0, 100)}</p>
                            {descriptionCollapse ? (
                                <span onClick={showLess} className='card-link collapse-btn'>
                                    See Less <FontAwesomeIcon className='icon' icon={faArrowAltCircleLeft} />
                                </span>
                            ) : (
                                <span onClick={showMore} className='card-link collapse-btn'>
                                    See More <FontAwesomeIcon className='icon' icon={faArrowAltCircleRight} />
                                </span>
                            )}
                        </div>
                    </div>
